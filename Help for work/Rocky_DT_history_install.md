# Легенда
- Обозначение серверовв ДТ web - sudo ansible-playbook -i /etc/ansible/hosts/packages.yml --vault-password-file /root/ansible_pass /etc/ansible/playbooks/packages.yml
- Обозначаем сервера для опроса /etc/ansible/playbooks/packages.yml
...
sudo dnf update
   ...
   28  ss -tulpn
   29  sudo ss -tulpn
   30  sudo systemctl status avahi-daemon.s
   31  sudo systemctl status avahi-daemon.service
   32  sudo systemctl stop avahi-daemon.service
   33  sudo systemctl status avahi-daemon.service
   34  sudo systemctl stop avahi-daemon.socket
   35  sudo ss -tulpn
   36  sudo systemctl disable avahi-daemon.socket
   37  sudo systemctl disable avahi-daemon.service
   38  sudo hostnamectl set-hostname
  ...
  374  pwd
  375  cd ~/scripts/
  376  nano main_packages_exporter.sh
  377  bash main_packages_exporter.sh
  378  rm main_packages_exporter.sh
  379  nano main_packages_exporter.sh
  380  bash main_packages_exporter.sh
  381  sudo bash main_packages_exporter.sh
  382  nano main_packages_exporter.sh
  383  sudo bash main_packages_exporter.sh
  384  nano main_packages_exporter.sh
  385  nano DT_os_packages_exporter.sh
  386  sudo bash main_packages_exporter.sh
  387  ls
  388  rm DT_os_packages_exporter.sh
  389  nano DT_os_packages_exporter.sh
  390  sudo bash main_packages_exporter.sh
  391  ls -l
  392  nano DT_os_packages_exporter.sh
  393  ls -l
  394  sudo bash main_packages_exporter.sh
  395  ls -la
  396  pwd
  397  ls -la /home/ksb/bom_gen/
  398  sudo bash main_packages_exporter.sh
  399  pwd
  400  cd ../
  401  mc
  402  sudo mc
  403  cd ~/scripts/
  404  sudo bash main_packages_exporter.sh
  405  sudo crontab -l
  406  sudo crontab -e
  407  sudo crontab -l
  408  sudo mkdir /var/log/sca
  409  sudo touch /var/log/sca/cpe_exporter.log
  410  sudo touch /var/log/sca/main_packages_exporter.log
  411  sudo systemctl restart crond.service
  412  history